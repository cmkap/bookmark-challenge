...
describe Bookmark do
  ...
  describe '.all' do
    it 'returns all bookmarks' do
      ...
      Bookmark.create(url: 'http://www.destroyallsoftware.com', title: 'Destroy All Files')
  ...
  describe '.create' do
    ...
    it 'does not create a new bookmark if the URL is not valuis' do
  ...
  describe '.delete' do
    it 'deletes the given bookmark' do
      #setup-arrange
      bookmark = Bookmark.create(title: 'NBA', url: 'http://www.nba.com')
      #exercise-act
  ...
  describe '.where' do
    it 'returns bookmarks with the given tag id' do
      bookmark = Bookmark.create(url: "http://google.com", title: "Google")
